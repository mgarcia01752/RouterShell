...
configurator.enable_dhcp_server('192.168.0.100', '192.168.0.200', '12h')
configurator.enable_dhcp_server_with_netmask('192.168.1.50', '192.168.1.100', '255.255.255.0', '8h')
configurator.enable_dhcp_server_with_tag('mytag', '192.168.2.10', '192.168.2.20', '6h')
configurator.enable_dhcp_server_for_tag('mytag', '192.168.2.10', '192.168.2.20', '6h')
configurator.enable_tftp_server('/path/to/tftp')
